...
A figura a seguir, referenciada a partir da  https://docs.cloud.google.com/netapp/volumes/docs["Documentação do Google Cloud NetApp Volumes"^], apresenta uma visão geral de alto nível.
